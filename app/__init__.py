...
def submit_code():
    ...
    # TODO: Submit code
        ...
        if lang =="python":
            ...
            print('{"name":"'+questionName+'","input":[10],"url":"https://s3.amazonaws.com/test-yuanyi/'+s3_url+'"}')
            ...
            print('{"input": "[3,4]","name": "'+questionName+'","url": "https://s3.amazonaws.com/test-yuanyi/'+s3_url+'"}')
...
@app.route('/problems/solution',methods=['GET','POST'])
def problems_solve():
    description=""
    if request.args.get('name')!=None:
        questionName=request.args.get('name')
        table = dynamodb.Table('question')
        response = table.get_item(
            Key={
                'question_name':questionName
